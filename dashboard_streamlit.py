...
for i in options:
    plt.clf()
    if i == 'Total':
        plt.bar(site_A_cat_2020['Month'], site_A_cat_2020[i].squeeze(), 0.25, alpha = 0.8, label = i + ' (2020)')
        plt.bar(site_A_cat_2021['Month'] + 0.25, site_A_cat_2021[i].squeeze(), 0.25, alpha = 0.8, label = i +' (2021)')
        plt.bar(df_2022['Month'] + 0.5, df_2022[i].squeeze(), 0.25, alpha = 0.8, label='Forecast (2022)')
        plt.bar(df_2023['Month'] + 0.75, df_2023[i].squeeze(), 0.25, alpha = 0.8, label='Forecast (2023)')
    else:
        plt.bar(site_A_cat_2020['Month'], site_A_cat_2020.loc[:, (slice(None), i)].squeeze(), 0.25, alpha = 0.8, label = i + ' (2020)')
        plt.bar(site_A_cat_2021['Month'] + 0.25, site_A_cat_2021.loc[:, (slice(None), i)].squeeze(), 0.25, alpha = 0.8, label = i +' (2021)')
        plt.bar(df_2022['Month'] + 0.5, df_2022[i].squeeze(), 0.25, alpha = 0.8, label='Forecast (2022)')
        plt.bar(df_2023['Month'] + 0.75, df_2023[i].squeeze(), 0.25, alpha = 0.8, label='Forecast (2023)')
    ax = plt.subplot(111)
    box = ax.get_position()
